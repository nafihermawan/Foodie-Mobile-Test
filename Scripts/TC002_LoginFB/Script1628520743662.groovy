...
Mobile.tapAndHold(findTestObject('Object Repository/android.widget.Button - Lanjutkan'), 0, 0)

Mobile.verifyElementText(findTestObject('Object Repository/android.widget.TextView - Nafi Hermawan'), 'Nafi Hermawan')
